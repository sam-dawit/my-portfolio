        ...
        <div>
            <main>
                <div className="bg-gray-800 text-white py-20 text-center">
                    <h2 className="text-4xl font-bold">Hi, I'm John Watson</h2>
                    <p className="text-lg mt-2 font-light">Freelancer</p>
                    <p className="mt-4 max-w-2xl mx-auto">
                        I specialize in UI/UX Design and Web Development,
                        creating innovative and user-friendly experiences.
                    </p>
